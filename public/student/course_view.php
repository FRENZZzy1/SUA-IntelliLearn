...
<main class="main-content" id="dashMain">
    ...
    <?php elseif ($activeView === 'materials'): ?>
        ...
        <section class="panel panel--card">
            <div class="panel-header">
                <h2><i class="fas fa-book-open"></i> Learning Materials · <?= htmlspecialchars($terms[$activeTerm]['label']) ?></h2>
            </div>
                    ...
                    ?>
                        <li class="material-item" style="--mat-accent: <?= $matAccent ?>; --mat-accent-light: <?= $matAccentLight ?>;">
                            ...
                            <div class="material-info">
                                <a class="material-title" href="<?= htmlspecialchars($matUrl) ?>" target="_blank" rel="noopener">
                            ...
                            <div class="material-actions">
                                <a href="<?= htmlspecialchars($matUrl) ?>" target="_blank" rel="noopener" class="qa-btn" title="Open">
                            ...
                            <li class="material-item">
                                ...
                                <div class="material-info">
                                    ...
                                    <div class="material-meta">
                                        ...
                                        <?php if ($a['score'] !== null): ?>
                                            · Score: <?= rtrim(rtrim((string) $a['score'], '0'), '.') ?>/<?= rtrim(rtrim((string) $a['points'], '0'), '.') ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
        ...
        <?php else: ?>
            ...
            <section class="panel panel--card">
                ...
                <?php if ($attachmentUrl): ?>
                    <a class="material-title attachment-link" href="<?= htmlspecialchars($attachmentUrl) ?>" target="_blank" rel="noopener">
                ...
                <div class="course-teacher-row" style="margin-top: 18px;">
                    <div class="course-teacher-info" style="width:100%;">
                        <div class="course-teacher-name">
                            Your submission
                            <span class="chip chip-<?= $statusInfo['class'] ?>" style="margin-left:8px;"><?= $statusInfo['label'] ?></span>
                        </div>
                        ...
                        <?php if ($selectedAssignment['submission_id']): ?>
                            <div class="material-meta" style="margin-top:6px;">
                                ...
                                <?php if ($selectedAssignment['score'] !== null): ?>
                                    · Score: <?= rtrim(rtrim((string) $selectedAssignment['score'], '0'), '.') ?>/<?= rtrim(rtrim((string) $selectedAssignment['points'], '0'), '.') ?>
                                <?php endif; ?>
                            </div>
                            <?php if ($submissionUrl): ?>
                                <a href="<?= htmlspecialchars($submissionUrl) ?>" target="_blank" rel="noopener" class="link-view">View your submission</a>
                            <?php elseif (!empty($selectedAssignment['submission_text'])): ?>
                                <p class="assignment-description"><?= nl2br(htmlspecialchars($selectedAssignment['submission_text'])) ?></p>
                            <?php endif; ?>
                            <?php if (!empty($selectedAssignment['feedback'])): ?>
                                <div class="material-meta" style="margin-top:6px;"><strong>Feedback:</strong> <?= htmlspecialchars($selectedAssignment['feedback']) ?></div>
                            <?php endif; ?>
                        <?php else: ?>
                            <p class="field-hint" style="margin-top:6px;">You haven't submitted anything for this assignment yet.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </section>
                            ...
                            <li class="material-item">
                                ...
                                <div class="material-info">
                                    ...
                                    <div class="material-meta">
                                        ...
                                        · <span class="chip chip-<?= $attemptStatus['class'] ?>"><?= $attemptStatus['label'] ?></span>
                                        <?php if ($q['score'] !== null): ?>
                                            · Score: <?= rtrim(rtrim((string) $q['score'], '0'), '.') ?><?php if ($q['max_score'] !== null): ?>/<?= rtrim(rtrim((string) $q['max_score'], '0'), '.') ?><?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <a class="btn-secondary btn-view-submissions"
            ...
            <section class="panel panel--card">
                <div class="panel-header">
                    ...
                    <span class="enrolled-badge">
                        ...
                        <?php endif; ?>
                        · <?= (int) $selectedQuiz['max_attempts'] ?> attempt<?= (int) $selectedQuiz['max_attempts'] === 1 ? '' : 's' ?> allowed
                    </span>
                </div>
                            ...
                            <tbody>
                                <?php foreach ($quizAttempts as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row['score'] !== null ? rtrim(rtrim((string) $row['score'], '0'), '.') . ($row['max_score'] !== null ? '/' . rtrim(rtrim((string) $row['max_score'], '0'), '.') : '') : '—' ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
