                ...
                <div id="editStudentFields" style="display:none;">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="guardian_contact" id="editGuardianContact" class="form-control" placeholder="+63 912 345 6789" pattern="(?:09\d{9}|\+63\s?9\d{2}\s?\d{3}\s?\d{4})" maxlength="16" inputmode="tel" title="Use 09XXXXXXXXX or +63 9XX XXX XXXX format">
                        </div>
                    </div>
                </div>
