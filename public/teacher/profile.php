<?php
/**
 * SUA IntelliLearn - Teacher Profile Settings
 * St. Uriel Academy Teacher Portal
 */

require_once '../../config/config.php';
require_once 'assets/api/dashboard_functions.php';

requireTeacher();

$profile = get_teacher_profile($pdo, (int) $_SESSION['user_id']);
if (!$profile) {
...
<body>
                    ...
                    <div class="card-body profile-summary">
                        ...
                        <div class="profile-meta-list">
                            <div class="profile-meta-item">
                                <div class="meta-icon"><i class="fas fa-chalkboard-user"></i></div>
                            ...
                            <div class="profile-meta-item">
                                <div class="meta-icon"><i class="fas fa-building-columns"></i></div>
                                <div class="meta-content">
                                    <span class="label">Department</span>
                                    <span class="value"><?php echo htmlspecialchars($profile['department'] ?: 'Not set'); ?></span>
                                </div>
                            </div>
                            <div class="profile-meta-item">
                                ...
                                <div class="meta-content">
                                    ...
                                    <span class="value"><?php echo htmlspecialchars($profile['employment_status'] ?: 'Not set'); ?></span>
                                </div>
                            </div>
                            <div class="profile-meta-item">
                        ...
                        <div class="card-body">
                            ...
                            <form id="infoForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrap">
                                        <input type="text" id="department" name="department" value="<?php echo htmlspecialchars($profile['department']); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        async function profilePost(action, formData) {
            ...
            const res = await fetch('assets/api/profile_handler.php', {
                method: 'POST',
